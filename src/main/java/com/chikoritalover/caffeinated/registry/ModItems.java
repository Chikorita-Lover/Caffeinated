...
import com.chikoritalover.caffeinated.integration.farmersdelight.FDItemGroup;
...
public class ModItems {
    ...
    @Nullable
    public static ItemGroup getCrateItemGroup() {
        if (!FabricLoader.getInstance().isModLoaded("farmersdelight")) {
            return null;
        }
        return FDItemGroup.getFDItemGroup();
    }
}

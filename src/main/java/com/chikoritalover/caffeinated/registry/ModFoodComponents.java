...
public class ModFoodComponents {
    ...
    public static final FoodComponent TIRAMISU = (new FoodComponent.Builder()).hunger(9).saturationModifier(0.3F).statusEffect(new StatusEffectInstance(ModStatusEffects.CAFFEINE, 600, 1), 1.0F).build();
}

...
public class CaffeinatedAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(RegistryWrapper.WrapperLookup registries, Consumer<AdvancementEntry> exporter) {
        ...
        requireAllCoffeeBottles(Advancement.Builder.create().parent(brewCoffee).display(CaffeinatedItems.MILK_COFFEE_BOTTLE, Text.translatable("advancements.husbandry.drink_all_coffee.title"), Text.translatable("advancements.husbandry.drink_all_coffee.description"), null, AdvancementFrame.CHALLENGE, true, true, false), CaffeinatedItems.COFFEE_BOTTLE, CaffeinatedItems.MILK_COFFEE_BOTTLE, CaffeinatedItems.HONEY_COFFEE_BOTTLE).rewards(AdvancementRewards.Builder.experience(100)).build(exporter, of("husbandry/drink_all_coffee"));
